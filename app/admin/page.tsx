...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold tracking-tight text-brand-dark-blue">Admin Dashboard</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
         <Card className="shadow-md">
          <CardHeader>
            <div className="flex justify-between items-center">
                <CardTitle className="text-brand-dark-blue">Pending Buyer Verifications</CardTitle>
        ...
        <Card className="shadow-md">
          <CardHeader>
            <div className="flex justify-between items-center">
                <CardTitle className="text-brand-dark-blue">Pending Seller/Listing Verifications</CardTitle>
                <Button variant="outline" size="sm" asChild>
        ...
        <Card className="shadow-md">
          <CardHeader>
             <div className="flex justify-between items-center">
                <CardTitle className="text-brand-dark-blue">Ready for Connection</CardTitle>
                <Button variant="outline" size="sm" asChild>
      ...
      <Card className="shadow-md">
        <CardHeader>
          <CardTitle className="text-brand-dark-blue">Quick Links</CardTitle>
        </CardHeader>
