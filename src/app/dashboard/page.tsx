...
import { MessageSquare, ShieldCheck, CheckCircle2, Eye, Search, LayoutDashboard, ExternalLink, User, Clock, AlertCircle, TrendingUp, Send, UserCircle, ListFilter, Bookmark, Inbox, UserCheck, ArrowRight, Loader2, RefreshCw, Timer, Verified } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <CardContent>
              <div className="text-2xl font-bold">{stats.savedListingsCount}</div>
              <p className="text-xs text-muted-foreground">
