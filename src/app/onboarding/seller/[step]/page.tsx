...
export default function SellerOnboardingStepPage() {
  ...
  const getDefaultValues = (data: FormValues): FormValues => ({
    ...
    sellerIdentityFile: data.sellerIdentityFile || null,
    businessRegistrationFile: data.businessRegistrationFile || null,
    proofOfOwnershipFile: data.proofOfOwnershipFile || null,
    profitAndLossFile: data.profitAndLossFile || null,
    balanceSheetFile: data.balanceSheetFile || null,
