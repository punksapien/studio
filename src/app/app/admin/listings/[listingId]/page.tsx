                    ...
                    <aside className="space-y-6 md:sticky md:top-24 h-fit">
                        <Card className="shadow-md bg-brand-light-gray/50">
                            ...
                            <CardContent className="space-y-3 text-sm">
                                ...
                                {seller && (
                                  <>
                                    <p><span className="font-medium text-brand-dark-blue">Seller:</span> <Link href={`/app/admin/users/${seller.id}`} className="text-primary hover:underline">{seller.fullName}</Link></p>
