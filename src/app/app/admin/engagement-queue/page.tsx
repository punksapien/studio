                ...
                {engagements.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="font-medium whitespace-nowrap">
                        <Link href={`/app/admin/users/${item.buyerId}`} className="hover:underline">{item.buyerName}</Link>
                    </TableCell>
                    <TableCell>{getVerificationBadge(item.buyerVerificationStatus)}</TableCell>
                     <TableCell className="font-medium whitespace-nowrap">
                        <Link href={`/app/admin/users/${item.sellerId}`} className="hover:underline">{item.sellerName}</Link>
                    </TableCell>
                    <TableCell>{getVerificationBadge(item.sellerVerificationStatus)}</TableCell>
                    <TableCell className="whitespace-nowrap">
                        <Link href={`/app/admin/listings/${item.listingId}`} className="hover:underline">{item.listingTitle}</Link>
                    </TableCell>
